...
As we realized in the class, mostly Mac users have default zsh terminal shells where * (asterisk) does not work, which causes issues when doing secure copying. The solution here is to switch from zsh shell to bash shell and we might want to add this note into the tutorials for the future class.
...
In brief, go here and activate the Windows Subsytems for Linux
...
how to find your files (your own computer files)

`cd /mnt/c`
That is your C drive. Your files would be under Users, your username. 

How to **copy & paste** in terminal in a ubuntu in windows OS. 
...
:::success
We recommend you to use a text editor or even websites such as this one, [HackMD](https://hackmd.io/) or [Github](https://github.com/)
